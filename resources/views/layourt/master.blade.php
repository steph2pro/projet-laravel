...
<meta name="theme-color" content="#712cf9">
    ...
    <link href="{{asset('js/offcanvas.css')}}" rel="stylesheet">
  </head>
  <body class="bg-light">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{route('accueil')}}">Acueil</a>
        </li>
        <li class="nav-item">
...
<main class="container">
  <div class="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm">
    <div class="lh-1">
      <h1 class="h6 mb-0 text-white lh-1">EtudiantCrud</h1>
      <small>Since 2004</small>
    </div>
  </div>

     <!--pour que toute les page qui vont eriter insere du contenue dinamiquement !-->
     @yield("contenu")
</main>
